...
public class Item11Act extends JPanel implements ItemListener,ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		// TODO Auto-generated method stub
		if (e.getSource()==jb1){
			String sql = "insert into student (S_id,S_name,S_sex,S_birth,S_prov,S_into,Dept_id)values ('"
						+jt1.getText()+"','"+jt2.getText()+"','"+jt3.getText()+"','"
						+jt4.getText()+"','"+jt5.getText()+"','"+jt6.getText()+"','"+jt7.getText()+"');";
			...
			String sql = "update student set "+jc1.getSelectedItem()+" = '"+jt2.getText()+"' where S_id="
							+jt1.getText()+";";
			System.out.println(sql);
			Statement statement = null;	 
			try {
			...
			String sql = "delete from student where S_id ="+jt1.getText()+";";
			System.out.println(sql);
			Statement statement = null;
			try {
				statement = DBConnection.getConnection().createStatement();
